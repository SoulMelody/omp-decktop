...
import { Eye, EyeOff, FoldVertical, ListTodo, Menu, PanelRight, Terminal, UnfoldVertical, X } from "lucide-react";
...
/**
 * The more aggressive "hide tool calls" mode — while on, tool calls render
 * nothing but a live spinner + the running tool's name, with no history trail
 * once a turn finishes (see `AssistantMessage.tsx`). This is a separate axis
 * from `ToolCardsToggle`'s collapse/expand; it takes visual precedence when
 * active, but `ToolCardsToggle` stays clickable underneath.
 */
